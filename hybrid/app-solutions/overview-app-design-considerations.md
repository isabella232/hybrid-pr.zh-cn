...
有关此要素的核心介绍，请参阅卓越体系结构五个要素中的[可用性](/azure/architecture/framework/)。
...
有关此要素的核心介绍，请参阅卓越体系结构五个要素中的 [DevOps](/azure/architecture/framework/#devops)。
...
- [开发用于实现云一致性的 Azure 资源管理器模板](/azure/azure-resource-manager/templates/templates-cloud-consistency)